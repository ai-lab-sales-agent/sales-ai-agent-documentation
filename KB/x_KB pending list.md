...
| KB Piece | Purpose / Description | Status |
|---|---|---|
| Timeline | Estimated duration for each phase (discovery, design, build, testing, launch), what affects the timeline, typical end-to-end range | Waiting — define after current Botpress implementation is complete and universal roadmap is developed |
| Multi-Language / Localization | Whether the agent can operate in non-English languages, what's technically possible, testing challenges for translation quality | Waiting — to be discussed with the team before adding to KB |
