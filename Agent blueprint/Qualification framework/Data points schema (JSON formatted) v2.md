...
```json
{
  ...
  "properties": {
    ...
    "knowledge_gap_email_provided": {
      "type": "boolean",
      "description": "True if the agent provided a contact email address during a knowledge gap scenario. Agent offers alternative + email, then continues discovery.",
      "default": false
    },
...
```json
{
  ...
  "properties": {
    ...
    "knowledge_gap_email_provided": { "type": "boolean", "default": false, "description": "True if agent provided contact email during knowledge gap." },
...
| Category | CH | A | M | P | Action |
|----------|-----|-----|-----|-----|--------|
| **Hot** | ✓ | ✓ | ✓ | ✓ | Calendly (tag: Hot) |
| **Warm** | ✓ | 1-2 of A/M/P missing (at least 1 confirmed) | | | Calendly (tag: Warm) |
| **Nurture** | weak/vague | M/P not established | | | Resources → re-qualify → soft nudge |
| **DQ** | — | — | — | — | No need, wrong scope, no sales team, spam, ICP exclusion, or budget < €5,000 |
