...
| **Status**        | Draft                                                                         |
| **Based On**      | Discovery Document (Feb 2026), PRD v1 (Feb 19, 2026)                          |
| **Related Docs**  | MVP Roadmap, Comparison Table, Scoring Matrix, Botpress Overview, Qualification Framework v2.1.0, Handoff Rules v2.0.0, Decision Tree v2.1.0 |
...
**US-4** — As a visitor, I want to reach the sales team when the agent can't fully answer my question.
> **Acceptance:** For knowledge gaps (partial or full), the agent suggests an alternative topic it can help with and provides a contact email for human follow-up. For booking declines, a contact form (name, email, company, message) is presented as fallback.
...
**Warm**
- **Criteria:** Need (Challenges) confirmed. 1–2 of Authority / Money / Prioritization confirmed, but not all — at least 1 of the 3 is positive. Potential fit.
- **Action:** Book meeting immediately.
- **Conversion path:** Calendly link presented in chat (tagged Warm).

**Nurture**
- **Criteria:** Early-stage interest — Challenges not yet defined (Early Nurture after Step 5), or Challenges confirmed but none of Authority / Money / Prioritization positive (Standard Nurture after Step 10).
- **Action:** Share resources → re-qualify → soft Calendly nudge. Can upgrade to Warm or Hot if signals improve.
- **Conversion path:** Resources → re-qualification → upgrade or soft Calendly nudge.
...
#### 3.4.1 Contact Form (Rejection to Book a Meeting) / Contact Email (Knowledge Gap)

**Contact form** — When a Hot or Warm lead declines Calendly booking, the agent presents an in-chat contact form to capture structured lead data for manual outreach.

**Contact email** — When the visitor asks something the agent cannot fully answer (partial or no knowledge), the agent responds with what it can, suggests an alternative topic it can help with, provides a contact email for human follow-up, and resumes the discovery flow. The email is lower-friction than a form and doesn't interrupt the conversation.
...
| **Trigger**     | Lead scored as Hot or Warm (Calendly presented for both, tagged by category) |
...
- Immediate or real-time connection to the team (the team is not available 24/7)
...
| **Agent doesn't know the answer** | Provide partial answer if possible. Suggest alternative topic. Provide contact email. Resume discovery. |
| **Visitor raises objection** | Acknowledge, address with KB content, reframe value, resume flow. Do not offer discounts or pressure. |
...
4. **Contact email is provided for knowledge gaps; contact form is presented when visitor declines Calendly booking**
   - Verification: Knowledge gap → email provided, discovery resumes. Calendly decline → form presented. Data received correctly.
...
| **Qualification Framework** | Qualification Framework v2.1.0                                 |
| **Handoff Rules**       | Handoff Rules v2.0.0                                                |
| **Decision Tree**       | Sales AI Agent Decision Tree v2.1.0                                 |

---

*End of document. This PRD v2 is based on the Discovery Document, PRD v1 (Feb 19, 2026), and alignment with Qualification Framework v2.1.0, Handoff Rules v2.0.0, and Decision Tree v2.1.0. Key changes from v1: Calendly trigger extended to Warm leads, Knowledge Gap path split (email for gaps, form for Calendly declines), Nurture flow expanded to N1–N5 with upgrade path, visitor_phone removed, "Must NOT Promise" updated. Updates to scope or requirements should be reflected in a new version of this PRD.*
